...
public class AuthenticationInterceptor implements Interceptor{
    ...
    public String intercept(ActionInvocation ai) throws Exception {
        ...
        {
            if(getRequestedPage(request).contains("student")&&user.getUsername().equals("student"))
              return ai.invoke();
            else if(getRequestedPage(request).contains("teacher")&&user.getUsername().equals("teacher"))
              return ai.invoke();
