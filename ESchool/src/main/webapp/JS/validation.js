...
function validateAddStudentInClassForm(theForm) {
  ...
  var reason = "";
  reason += validateEmpty(theForm.addStudentInClassForm_student);
  reason += validateEmpty(theForm.addStudentInClassForm_classNo);
  console.log(reason);
  if (reason !== "") {
    document.getElementById('loginError').style.visibility = 'visible';
    document.getElementById('loginError').innerHTML = "Моля попълнете всички полета!\n";
...
function validateAddRemark(theForm) {
  ...
  reason += validateEmpty(theForm.createRemark_subjectName);
  reason += validateEmpty(theForm.date);
  console.log(reason);
  if (reason !== "") {
    document.getElementById('loginError').style.visibility = 'visible';
